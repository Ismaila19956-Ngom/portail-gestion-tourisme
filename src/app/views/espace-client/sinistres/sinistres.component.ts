                ...
                <div class="hist-table">
                    ...
                    <div *ngFor="let r of historyRows; let even=even"
                        ...
                        <div class="col-r">
                            ...
                            <span *ngIf="r.montantEvalue == null" style="color:#ccc;">â€”</span>
                        </div>
                        <div class="col-c">
...
export class SinistresComponent implements OnInit {
    ...
    private _toRow(s: any): SinistreRow {
        ...
        return {
            id:              s.id,
            numeroDossier:   s.numeroDossier || 'â€”',
            policeNum:       s.police?.numeroPolice || 'â€”',
            produitNom:      s.police?.produit?.nom || 'â€”',
            dateSurvenance:  s.dateSurvenance  || '',
            dateDeclaration: s.dateDeclaration || '',
            montantEvalue:   s.montantEvalue ?? null,
            statutLabel:     s.statut?.description || s.statut?.name || String(s.statut || 'â€”'),
            statutDot,

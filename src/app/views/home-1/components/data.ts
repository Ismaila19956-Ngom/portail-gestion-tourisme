...
const serviceData: ServiceType[] = [
    {
        duration: 800,
        image: 'assets/images/tourisme/service_culture.png',
        id: 1,
    ...
    {
        duration: 900,
        image: 'assets/images/tourisme/service_safari.png',
        id: 2,
        title: 'Safari & Nature',
    ...
    {
        duration: 1000,
        image: 'assets/images/tourisme/service_aventure.png',
        id: 3,
        title: 'Aventure & Randonnée',
        description: 'Explorez les forêts de Casamance, les dunes de Lompoul ou les collines de Dindefelo à pied ou en 4x4.',
    },
    {
        duration: 1100,
        image: 'assets/images/tourisme/service_plage.png',
        id: 4,
        title: 'Croisières & Plages',
        description: 'Naviguez sur le fleuve Sénégal, le delta du Saloum ou partez en mer avec nos pêcheurs locaux.',
    },
    {
        duration: 1200,
        image: 'assets/images/tourisme/service_gastro.png',
        id: 5,
...
const faqData: FAQType[] = [
    {
        ...
        answer: 'Vous pouvez réserver directement sur notre site en cliquant sur "Réserver" de l\'excursion choisie, nous contacter par WhatsApp au +221 77 654 32 10, ou envoyer un email à contact@senegal-excursions.sn. La confirmation est envoyée sous 2 heures.'
    },
    {
    ...
    },
    {
        ...
        answer: 'Oui, l\'annulation est gratuite jusqu\'à 48h avant le départ. Entre 48h et 24h, 50% du montant est retenu. Moins de 24h, la totalité est due. Vous pouvez modifier votre date sans frais jusqu\'à 72h avant.'
    },
    {
    ...
    },
    {
        ...
        answer: 'Le prix inclut le transport aller-retour depuis Dakar, le guide local certifié, les entrées des sites visités et les repas mentionnés dans le programme. Les boissons personnelles et les achats souvenirs sont à votre charge.'
    },
    {
...
const blogs: BlogType[] = [
    {
        ...
        description: 'Le delta du Sine-Saloum, classé Réserve de Biosphère par l\'UNESCO, offre des paysages à couper le souffle. Découvrez comment en profiter au maximum.',
        aos: 'flip-left',
        duration: 800
    },
    {
    ...
    {
        image: 'assets/images/tourisme/excursion_casamance_1781800557434.png',
        title: 'Casamance : la région secrète que tout voyageur doit découvrir',
        date: '20 Août 2025',
        category: 'Aventure',
...
const testimonialData: TestimonialType[] = [
    {
        message: 'Notre excursion dans le Sine-Saloum était tout simplement magique. Le guide Ibrahima connaît chaque recoin du delta. La pirogue à travers les mangroves au coucher du soleil est un souvenir inoubliable. Je recommande à 100% !',
    ...
    {
        message: 'L\'île de Gorée nous a profondément émus. Le guide a raconté l\'histoire avec beaucoup d\'émotion et de respect. L\'organisation était parfaite, de la réservation au retour. Merci infiniment à toute l\'équipe !',
        authorImg: 'assets/images/tourisme/voyageur_1.png',
        name: 'Aminata Diallo',
        role: '🇸🇳 Touriste – Avril 2025',
    },
    {
        message: 'Première fois au Sénégal et quelle découverte ! L\'excursion à Saint-Louis et au parc des oiseaux du Djoudj était incroyable. Mamadou et son équipe sont des professionnels passionnés. Bravo !',
    ...
    {
        message: 'مذهل! رحلة السفاري في حديقة نيوكولو كوبا كانت من أجمل تجاربي في حياتي. الدليل محترف جداً ويعرف كل شيء عن الحيوانات. أنصح بشدة بهذه الوكالة لكل المسافرين.',
        authorImg: 'assets/images/tourisme/voyageur_3.png',
        name: 'Ahmed Al-Rashidi',
        role: '🇸🇦 Touriste – Juin 2025',
    },
    {
        message: 'Nous avons emmené nos trois enfants pour l\'excursion famille au parc de Bandia. C\'était adapté à tous les âges, sécurisé et vraiment enrichissant. Les enfants ont adoré voir les rhinocéros et les girafes !',
